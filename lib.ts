...
import { getModels, setModel, populateDB, changeProvider } from "./modelHandle.ts";
export { getModels, setModel, populateDB, changeProvider };
...
const schemafile =await Deno.readFile("schema.sql");
const schema = `${decoder.decode(schemafile)}`;
